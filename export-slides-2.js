...
async function exportSlides() {
    ...
    // Load the HTML file
    const filePath = path.join(__dirname, 'youtube-live-2-slides.html');
    ...
    for (let i = 0; i < slideCount; i++) {
        ...
        const outputPath = path.join(__dirname, 'youtube-live-2-slides-images', `slide-${slideNumber}.png`);
    ...
    await browser.close();
    console.log('\nAll slides exported to youtube-live-2-slides-images/');
}
