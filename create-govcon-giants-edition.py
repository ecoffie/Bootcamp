#!/usr/bin/env python3
"""
Create GovCon Giants Complementary Database
Enhanced version with GovCon Giants branding and integration
"""
...
# NAICS code descriptions (same as before)
NAICS_DESCRIPTIONS = {
...
# Create GovCon Giants branded HTML
...
<head>
    ...
    <meta name="description" content="Free searchable database of 2,768 federal contractors with $479.9B in contract data. Perfect companion tool for GovCon Giants members.">
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<div class="container">
    ...
    <div class="info-bar">
        <strong>💡 Pro Tip:</strong> Use this database to identify prime contractors in your industry, then learn how to partner with them through
        <a href="https://govcongiants.org" target="_blank">GovCon Giants training and mentorship</a>.
    </div>
...
# Write output
output_file = '/Users/ericcoffie/Bootcamp/GOVCON-GIANTS-CONTRACTOR-DATABASE.html'
with open(output_file, 'w', encoding='utf-8') as f:
    f.write(html_content)

print("=" * 80)
print("GOVCON GIANTS EDITION CREATED")
print("=" * 80)
print(f"\n✅ Created GovCon Giants branded database")
print(f"📊 Total companies: {len(companies):,}")
print(f"📄 File: {output_file}")
print(f"\n🎯 GOVCON GIANTS INTEGRATION:")
print(f"   • Green banner linking to GovConGiants.org")
print(f"   • Pro tip callout for training integration")
print(f"   • Footer with community links")
print(f"   • Branded as 'complementary tool'")
print(f"   • Encourages members to use GovCon Giants for mentorship")
print(f"\n🚀 NEXT STEPS:")
print(f"   1. Deploy to free hosting (GitHub Pages, Netlify, Vercel)")
print(f"   2. Share link with GovCon Giants community")
print(f"   3. Drives traffic to GovConGiants.org for paid services")
print("\n" + "=" * 80)
