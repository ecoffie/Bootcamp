...
| File/Directory | Description |
|----------------|-------------|
| `presentations/tempnet-staffing-presentation-v1.html` | Full deck; SAM notice types split; acronyms spelled out; uniform 960x540 slides |
| `presentations/tempnet-staffing-presentation-v2.html` | 10-15 min, 17 slides; acronyms spelled out; uniform 960x540 slides |

**Deck highlights (beginner foundation):**
- **NAICS focus**: 561320 (Temporary Help Services) + related support-service NAICS
...
| `files/IDIQ_Task_Order_Response_Template.docx` | Full proposal framework |
